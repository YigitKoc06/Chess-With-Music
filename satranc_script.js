...
const translations = {
    tr: {
        ...
        htpShortCastling: 'Kısa Rok (O-O)',
        htpShortCastlingDesc: 'Şahın, şah kanadındaki (yakın) kaleye doğru iki kare ilerlediği ve kalenin de şahın üzerinden atlayarak yanına geldiği hamledir. Şah ve kalenin daha önce oynamamış olması, aralarının boş olması ve şahın tehdit altında olmaması şarttır.',
        htpLongCastling: 'Uzun Rok (O-O-O)',
        htpLongCastlingDesc: 'Şahın, vezir kanadındaki (uzak) kaleye doğru iki kare ilerlediği ve kalenin de şahın üzerinden atlayarak yanına geldiği hamledir. Kısa rok ile tamamen aynı kurallara tabidir.',
    ...
    en: {
        ...
        htpShortCastling: 'Short Castling (O-O)',
        htpShortCastlingDesc: 'The king moves two squares towards the kingside rook, and the rook jumps over it. Allowed only if neither piece has moved before, the path is clear, and the king is not in check.',
        htpLongCastling: 'Long Castling (O-O-O)',
        htpLongCastlingDesc: 'The king moves two squares towards the queenside rook, and the rook jumps over it. Subject to the exact same rules as short castling.',
